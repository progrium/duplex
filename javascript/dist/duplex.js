...
(function() {
  ...
  duplex.API = (function() {
    function API(endpoint) {
      var codec, connect, parts, protocol, ref, scheme, url;
      parts = endpoint.split(":");
      assert("Invalid endpoint", parts.length > 1);
      scheme = parts.shift();
      ref = scheme.split("+", 2), protocol = ref[0], codec = ref[1];
      if (codec == null) {
        codec = "json";
      }
      ...
      connect = (function(_this) {
        return function(url) {
          ...
          _this.ws.onopen = function() {
            return _this.rpc.handshake(duplex.wrap.websocket(_this.ws), function(p) {
              var args, i, len, ref1, results;
              _this.peer = p;
              ref1 = _this.queued;
              results = [];
    ...
    API.prototype.call = function() {
      ...
      if (this.peer != null) {
        return (ref = this.peer).call.apply(ref, args);
      } else {
